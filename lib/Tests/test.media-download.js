...
import { DownloadableMessage, MediaType } from '../Types/index.js';
import { downloadContentFromMessage } from '../Utils/index.js';
jest.setTimeout(20000);
const TEST_VECTORS = [
    {
        type: 'image',
        message: proto.Message.ImageMessage.decode(Buffer.from('', 'base64')),
        plaintext: readFileSync('./Media/cat.jpeg')
    },
    {
        type: 'image',
        message: proto.Message.ImageMessage.decode(Buffer.from('', 'base64')),
...
//# sourceMappingURL=test.media-download.js.map